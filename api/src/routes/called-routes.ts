...
calledRoutes.get("/", verifyUserAuthorization(["customer", "technical", "admin"]), calledController.index);
calledRoutes.get("/search", verifyUserAuthorization(["technical", "admin"]), calledController.search);
